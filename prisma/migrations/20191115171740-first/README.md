# Migration `20191115171740-first`

This migration has been generated by Vincent Poulain at 11/15/2019, 5:17:40 PM.
...
You can use a specific Photon built for this migration (20191115171740-first)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191115171740-first'
