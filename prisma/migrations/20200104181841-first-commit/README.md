# Migration `20200104181841-first-commit`

This migration has been generated by Vincent Poulain at 1/4/2020, 6:18:41 PM.
...
You can use a specific Photon built for this migration (20200104181841-first-commit)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20200104181841-first-commit'
